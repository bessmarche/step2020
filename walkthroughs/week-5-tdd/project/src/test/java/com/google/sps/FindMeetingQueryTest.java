...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeIsConsidered() {
    // ++ ADDITIONAL TEST 2 ++ 
    // Have each person have different events with an optional attendee. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--||--C--||--B--|
    // Day     : |-------------------------------|
  ...
  @Test
  public void allDayOptionalAttendeeIsNotConsidered() {
    // ++ ADDITIONAL TEST 1 ++ 
    // Have each person have different events with an optional attendee. We should see two options because each person has
    // split the restricted times.
    //
  ...
  public void notEnoughRoomForOptionalAttendee() {
    // ++ ADDITIONAL TEST 3 ++ 
    // Have one attendee and one optional attendee, but make it so that there is just enough room at one point in the day to
    // have the meeting, if the optional guest is ignored. The optional attendee should be ignored since considering their schedule would result in a time slot smaller than the requested time.
    //
    // Events  : |--A--||-B-||----A----|
    // Day     : |---------------------|
    // Options :       |-----|
  ...
  public void noMandatoryAttendees() {
    // ++ ADDITIONAL TEST 4 ++ 
    // No mandatory attendees, just two optional attendees with different events.
    // Events  :       |--A--|       |--B--|
    // Day     : |-------------------------------|
    // Options : |--1--|                   |--2--|
   ...
   @Test
  public void noMandatoryAttendeesOptionalBusy() {
    // ++ ADDITIONAL TEST 5 ++ 
    // No mandatory attendees, just two optional attendees with different events.
    // Events  : |------A------||-------B--------|
    // Day     : |-------------------------------|
